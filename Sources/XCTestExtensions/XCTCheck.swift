...
public func XCTCheck<T>(_ value: T, matches other: T, options: XCTCheckOptions = .default, file: StaticString = #file, line: UInt = #line) throws where T: Matchable {
    try value.matches(other, context: MatchContext(options: options, file: file, line: line))
}

public func XCTCheck<T, I>(_ key: KeyPath<T, I>, of value: T, matches other: T, options: XCTCheckOptions = .default, file: StaticString = #file, line: UInt = #line) throws where I: Matchable {
